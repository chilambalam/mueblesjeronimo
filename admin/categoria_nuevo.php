...
<div id="caja">
        <p id="titulos_actualizar">
    		<img src="imagenes/triangulo.jpg" width="6" height="13" class="triangulo"/><span class="textogris">Nueva Categoria</span>
    	</p>
</div>
...
if (isset($_POST['Guardar']))
{
  ...
  extract($_REQUEST);
  mysql_select_db($database_con_admin, $con_admin);
  $sql = "INSERT INTO categoria (orden, titulo) VALUES ('$orden', '$titulo')";
  mysql_query($sql, $con_admin) or die(mysql_error());
  echo '<SCRIPT LANGUAJE="javascript">location.href="categoria2.php?menu='.$menu.'&page=1";</SCRIPT>';  
}
?>